        ...
        if file and allowed_file(file.filename):
            ...
            try:
                ...
                if 'sales' in df.columns:
                    ...
                    return redirect(url_for('analytics_auto'))
...
def auto_chart():
    ...
    return jsonify({
        ...
        "labels": chart_df[cat_col].astype(str).tolist(),
        "values": chart_df[num_col].tolist()
    })
